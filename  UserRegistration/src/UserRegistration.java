...
public class UserRegistration {
    ...
    private boolean analyseCardExpiryDate(String expiryDate) {
        ...
        if (year > currentYear || (year == currentYear && month >= currentMonth)) {
            ...
            System.out.println("Sorry, your card has expired. Please use a different card. Going back to the start to the registration process...");
            registration();
            return false;
        }
    }
    ...
    private void chargeFees() {
        ...
        System.out.printf("A fee of %.2f has been charged to your card ending with ****%s%n", 
    ...
    public String toString() {
        String cardNumberStr = String.valueOf(cardNumber);
        String digitsToCensor = cardNumberStr.substring(0, cardNumberStr.length() - 4);
        String censoredPart = digitsToCensor.replaceAll(".", "*");
        String lastFourDigits = cardNumberStr.substring(cardNumberStr.length() - 4);
